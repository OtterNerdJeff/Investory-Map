...
const STATUS_LIST = ["Operational","Spare","Under Maintenance","Waiting for Condemnation","Others"];
const STATUS_COLORS = {
...
const TYPE_ICON = {
  Projector:"📽",Visualiser:"📷","Patch Panel":"🔌",PatchPanel:"🔌",iPad:"📱","iPad Cart":"🛒",
  "Portable HD":"💾",MIC:"🎤",DSLR:"📸",Monitor:"🖥",PRINTER:"🖨",
  "Mobile Charging Cart":"🔋","S-Max":"📱","Old iPAD":"📱","Owned iPAD":"📱",
  DESKTOP:"💻",Camera:"📸",IPAD:"📱",default:"📦"
};
...
const RAW_ITEMS = [
  ...
  {id:"I004",sheet:"PNV",label:"PatchPanel Hall",assetCode:"",type:"Patch Panel",brand:"ABtUS",model:"TP-051-White",serial:"TP-05I-01727",location:"HALL",cost:"900",warrantyEnd:"2025-12-08",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // PAC
  {id:"I005",sheet:"PNV",label:"P PAC",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-EZ-590A",serial:"DD8610008",location:"D1-05 PAC Lobby",cost:"1981",warrantyEnd:"2024-01-14",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Conference Room
  {id:"I006",sheet:"PNV",label:"VS3103-08",assetCode:"",type:"Projector",brand:"Viewsonic",model:"SP7",serial:"XZC254301021",location:"Conference Room",cost:"1045",warrantyEnd:"2031-03-13",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I006b",sheet:"PNV",label:"PatchPanel Conf",assetCode:"",type:"Patch Panel",brand:"ABtUS",model:"AVS-390",serial:"390A-T1-00383",location:"Conference Room",cost:"0",warrantyEnd:"2027-03-13",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Dance Studio
  {id:"I007",sheet:"PNV",label:"P23",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW530",serial:"DC6640053",location:"D1-01 Dance Studio",cost:"758",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // PAL Room 1
  {id:"I008",sheet:"PNV",label:"P13",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW540",serial:"DC7610308",location:"D1-02 PAL Room 1",cost:"758",warrantyEnd:"2023-01-12",remark:"Change lamp on 19/2/2021",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I009",sheet:"PNV",label:"VN01",assetCode:"",type:"Visualiser",brand:"Newline",model:"TC-10P",serial:"C10UPV0S830035",location:"D1-02 PAL Room 1",cost:"399",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // PAL Room 2
  {id:"I010",sheet:"PNV",label:"P03",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW540",serial:"DC7610235",location:"D1-02 PAL Room 2",cost:"758",warrantyEnd:"2023-01-04",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Music Room 1
  {id:"I011",sheet:"PNV",label:"E2811_14",assetCode:"",type:"Projector",brand:"Epson",model:"EB982W",serial:"X8BL3600052",location:"E1-01 Music Room 1",cost:"1010",warrantyEnd:"2028-11-02",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I012",sheet:"PNV",label:"VA01",assetCode:"",type:"Visualiser",brand:"AVerVision",model:"315AF",serial:"5307033700198",location:"E1-01 Music Room 1",cost:"518",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I012b",sheet:"PNV",label:"PatchPanel MR1",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030203",location:"E1-01 Music Room 1",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29953",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Band Room
  {id:"I013",sheet:"PNV",label:"P04",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-EZ-590A",serial:"DD8610005",location:"E1-02 Band Room",cost:"1981",warrantyEnd:"2024-01-14",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I014",sheet:"PNV",label:"VN02",assetCode:"",type:"Visualiser",brand:"Newline",model:"TC-10P",serial:"C10UPV0S830046",location:"E1-02 Band Room",cost:"399",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I015",sheet:"PNV",label:"P05",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW540",serial:"DC7610267",location:"E1-02 Band Room",cost:"758",warrantyEnd:"2023-01-12",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Music Room 2
  {id:"I016",sheet:"PNV",label:"VS3103-09",assetCode:"",type:"Projector",brand:"Viewsonic",model:"SP7",serial:"XZC254301005",location:"E1-03 Music Room 2",cost:"1045",warrantyEnd:"2031-03-13",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I017",sheet:"PNV",label:"VA02",assetCode:"",type:"Visualiser",brand:"AVerVision",model:"315AF",serial:"5307033700032",location:"E1-03 Music Room 2",cost:"518",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I017b",sheet:"PNV",label:"PatchPanel MR2",assetCode:"",type:"Patch Panel",brand:"ABtUS",model:"AVS-390",serial:"390A-T1-00382",location:"E1-03 Music Room 2",cost:"0",warrantyEnd:"2027-03-13",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Teaching Lab
  {id:"I018",sheet:"PNV",label:"E2711_05",assetCode:"",type:"Projector",brand:"Epson",model:"EB982W",serial:"X8BL2600002",location:"B2-06 Teaching Lab",cost:"1010",warrantyEnd:"2027-11-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I019",sheet:"PNV",label:"VN03",assetCode:"",type:"Visualiser",brand:"Newline",model:"TC-10P",serial:"C10UPV0S830069",location:"B2-06 Teaching Lab",cost:"399",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I019b",sheet:"PNV",label:"PatchPanel TL",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-017987A",location:"B2-06 Teaching Lab",cost:"128",warrantyEnd:"2025-11-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // ITLR
  {id:"I020",sheet:"PNV",label:"P30",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW530",serial:"DC7110469",location:"ITLR",cost:"758",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I021",sheet:"PNV",label:"VN04",assetCode:"",type:"Visualiser",brand:"Newline",model:"TC-10P",serial:"C10UPV0S830072",location:"ITLR",cost:"399",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Learning Room 1
  {id:"I022",sheet:"PNV",label:"P08",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW540",serial:"DC7610236",location:"Learning Room 1",cost:"758",warrantyEnd:"2023-01-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I023",sheet:"PNV",label:"VN13",assetCode:"",type:"Visualiser",brand:"Newline",model:"TC-10P",serial:"C10UPV0S830061",location:"Learning Room 1",cost:"399",warrantyEnd:"",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Learning Lab 3
  {id:"I024",sheet:"PNV",label:"P12",assetCode:"",type:"Projector",brand:"Panasonic",model:"PT-VW540",serial:"DC7610227",location:"Learning Lab 3",cost:"758",warrantyEnd:"2023-01-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I024b",sheet:"PNV",label:"S Spare SAMSUNG",assetCode:"",type:"Visualiser",brand:"SAMSUNG",model:"UF 80ST",serial:"T6100100",location:"Learning Lab 3",cost:"2175",warrantyEnd:"",remark:"Served as personal backup",comment:"",status:"Spare",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Learning Lab 2
  ...
  {id:"I028b",sheet:"PNV",label:"PatchPanel LL1",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10675",serial:"320-T1-10675",location:"Learning Lab 1",cost:"0",warrantyEnd:"2028-02-18",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // LSP
  ...
  {id:"I030b",sheet:"PNV",label:"PatchPanel LSP",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-031427",location:"LSP",cost:"128",warrantyEnd:"2027-05-15",remark:"speaker: 40756",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Art Room 1
  ...
  {id:"I032b",sheet:"PNV",label:"PatchPanel AR1",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-019185",location:"Art Room 1",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29405",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Art Room 2
  ...
  {id:"I036",sheet:"PNV",label:"V2503_21",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P3",serial:"3022533",location:"Science Lab 1",cost:"385",warrantyEnd:"2025-03-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I036b",sheet:"PNV",label:"PatchPanel SL1",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-019184",location:"Science Lab 1",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29403",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Science Lab 2
  ...
  {id:"I038b",sheet:"PNV",label:"PatchPanel SL2",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030204",location:"Science Lab 2",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29947",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // LSM
  ...
  {id:"I040",sheet:"PNV",label:"V2503_22",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P3",serial:"3022535",location:"LSM",cost:"385",warrantyEnd:"2025-03-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Floor 2
  ...
  {id:"I042",sheet:"PNV",label:"V2802_40",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P3",serial:"3064610",location:"F2-01",cost:"365",warrantyEnd:"2028-02-25",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I042b",sheet:"PNV",label:"PatchPanel F2-01",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10671",serial:"320-T1-10671",location:"F2-01",cost:"0",warrantyEnd:"2028-02-12",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I044",sheet:"PNV",label:"V2502_17",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P3",serial:"3003634",location:"F2-02",cost:"385",warrantyEnd:"2025-02-11",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I044b",sheet:"PNV",label:"PatchPanel F2-02",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10674",serial:"320-T1-10674",location:"F2-02",cost:"0",warrantyEnd:"2028-02-12",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I046b",sheet:"PNV",label:"PatchPanel F2-03",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10673",serial:"320-T1-10673",location:"F2-03",cost:"0",warrantyEnd:"2028-02-12",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // G2
  ...
  {id:"I048b",sheet:"PNV",label:"PatchPanel G2-01",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-019183",location:"G2-01",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29339",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I050b",sheet:"PNV",label:"PatchPanel G2-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-031425",location:"G2-02",cost:"128",warrantyEnd:"2027-05-15",remark:"speaker: 40753",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I056b",sheet:"PNV",label:"PatchPanel SBB2",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-32147",location:"E3-03 SBB Room 2",cost:"128",warrantyEnd:"2027-09-19",remark:"speaker: 41104",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I058b",sheet:"PNV",label:"PatchPanel Math",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-31769",location:"E3-04 Math Room",cost:"128",warrantyEnd:"",remark:"Speaker: 41032",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I060b",sheet:"PNV",label:"PatchPanel F3-01",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018979",location:"F3-01",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29406",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I062b",sheet:"PNV",label:"PatchPanel F3-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-031426",location:"F3-02",cost:"128",warrantyEnd:"2027-05-15",remark:"speaker: 40755",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I066b",sheet:"PNV",label:"PatchPanel G3-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030208",location:"G3-02",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29954",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I070b",sheet:"PNV",label:"PatchPanel G3-04",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030209",location:"G3-04",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29948",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I072b",sheet:"PNV",label:"PatchPanel G3-05",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030212",location:"G3-05",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29952",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I074b",sheet:"PNV",label:"PatchPanel G3-06",assetCode:"",type:"Patch Panel",brand:"ABtUS",model:"AVS-390",serial:"390A-T1-00384",location:"G3-06",cost:"0",warrantyEnd:"2027-03-13",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Floor 4
  ...
  {id:"I076",sheet:"PNV",label:"V2302_02",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P",serial:"3433906",location:"E4-01",cost:"385",warrantyEnd:"2023-02-28",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I076b",sheet:"PNV",label:"PatchPanel E4-01",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10672",serial:"320-T1-10672",location:"E4-01",cost:"0",warrantyEnd:"2028-02-12",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I078b",sheet:"PNV",label:"PatchPanel E4-02",assetCode:"",type:"Patch Panel",brand:"",model:"320-T1-10676",serial:"320-T1-10676",location:"E4-02",cost:"0",warrantyEnd:"2028-02-18",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I080b",sheet:"PNV",label:"PatchPanel E4-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030205",location:"E4-03",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29951",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I084b",sheet:"PNV",label:"PatchPanel F4-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-017985A",location:"F4-02",cost:"128",warrantyEnd:"2025-11-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I086b",sheet:"PNV",label:"PatchPanel F4-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030207",location:"F4-03",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29950",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I088b",sheet:"PNV",label:"PatchPanel G4-01",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018954",location:"G4-01",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29402",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I090b",sheet:"PNV",label:"PatchPanel G4-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018967",location:"G4-02",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29400",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I092b",sheet:"PNV",label:"PatchPanel G4-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018955",location:"G4-03",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29404",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Floor 5
  ...
  {id:"I096b",sheet:"PNV",label:"PatchPanel E5-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018415A",location:"E5-02",cost:"128",warrantyEnd:"2025-11-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I098b",sheet:"PNV",label:"PatchPanel E5-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-018956",location:"E5-03",cost:"128",warrantyEnd:"2026-06-16",remark:"Speaker: 29401",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I100b",sheet:"PNV",label:"PatchPanel F5-01",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-017984A",location:"F5-01",cost:"128",warrantyEnd:"2025-11-24",remark:"",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I102b",sheet:"PNV",label:"PatchPanel F5-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-32148",location:"F5-02",cost:"128",warrantyEnd:"2027-09-19",remark:"speaker: 41106",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I104b",sheet:"PNV",label:"PatchPanel F5-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-32149",location:"F5-03",cost:"128",warrantyEnd:"2027-09-19",remark:"speaker: 41107",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I108b",sheet:"PNV",label:"PatchPanel G5-02",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-030206",location:"G5-02",cost:"128",warrantyEnd:"2026-11-02",remark:"speaker: 29949",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I110b",sheet:"PNV",label:"PatchPanel G5-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-32146",location:"G5-03",cost:"128",warrantyEnd:"2027-09-19",remark:"speaker: 41105",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  // Floor 6
  ...
  {id:"I116b",sheet:"PNV",label:"PatchPanel E6-03",assetCode:"",type:"Patch Panel",brand:"Optvio",model:"PS5H",serial:"OPT-031424",location:"E6-03",cost:"128",warrantyEnd:"2027-05-15",remark:"speaker: 40754",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  // Condemned
  {id:"I135",sheet:"CON",label:"P24 Epson",assetCode:"",type:"Projector",brand:"Epson",model:"EB-1940W",serial:"RL9F470060L",location:CONDEMNED_SECTION,cost:"968",warrantyEnd:"",remark:"-",comment:"Spoilt",status:"Waiting for Condemnation",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I140",sheet:"CON",label:"V2302_03",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P",serial:"3433907",location:CONDEMNED_SECTION,cost:"385",warrantyEnd:"2023-02-28",remark:"",comment:"",status:"Waiting for Condemnation",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I141",sheet:"CON",label:"V2312_13",assetCode:"",type:"Visualiser",brand:"ELMO",model:"MX-P2",serial:"3023823",location:CONDEMNED_SECTION,cost:"385",warrantyEnd:"2023-12-29",remark:"",comment:"",status:"Waiting for Condemnation",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  // iPad
  {id:"I144",sheet:"iPad",label:"iPad Cart 6",assetCode:"L00094318",type:"Mobile Charging Cart",brand:"V-lab",model:"V-Lab 40",serial:"0112",location:"6th Floor",cost:"0",warrantyEnd:"",remark:"Leasing",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I145",sheet:"iPad",label:"iPad Cart 7",assetCode:"L00094319",type:"Mobile Charging Cart",brand:"V-lab",model:"V-Lab 40",serial:"0106",location:"7th Floor",cost:"0",warrantyEnd:"",remark:"Leasing",comment:"",status:"Operational",loanable:false,isLoaned:false,loanedTo:"",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  ...
  {id:"I168",sheet:"OTH",label:"DMPS-HD08",assetCode:"0054-000325",type:"Portable HD",brand:"HP",model:"PX3100",serial:"8CY4481335",location:"Azlin",cost:"150",warrantyEnd:"",remark:"",comment:"H90540001485",status:"Operational",loanable:true,isLoaned:true,loanedTo:"Azlin",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I169",sheet:"OTH",label:"DMPS-HD23",assetCode:"0054-000247",type:"Portable HD",brand:"HP",model:"PX3100",serial:"8CY4481694",location:"Azlin",cost:"150",warrantyEnd:"",remark:"",comment:"H90540001407",status:"Operational",loanable:true,isLoaned:true,loanedTo:"Azlin",repairs:[],faults:[],moveLog:[],loanHistory:[]},
  {id:"I170",sheet:"OTH",label:"ECPS-HD01",assetCode:"0054-000202",type:"Portable HD",brand:"HP",model:"PX3100",serial:"8CY6193104",location:"Azlin",cost:"150",warrantyEnd:"",remark:"",comment:"H90540001362",status:"Operational",loanable:true,isLoaned:true,loanedTo:"Azlin",repairs:[],faults:[],moveLog:[],loanHistory:[]},
...
// ─── FLOATING WINDOW ──────────────────────────────────────────────────────────
function FloatingWindow({ item, detailTab, setDetailTab, onClose, onUpdate, onDelete, onAddRepair, onReportFault, onUpdateFault, onMove, onLoanOut, onReturn, setLightbox, allLocations }) {
  const [pos, setPos] = useState({ x: Math.max(20, window.innerWidth/2 - 190), y: Math.max(20, window.innerHeight/2 - 280) });
  ...
  const onMouseMove = useCallback(e => {
    if (!dragging) return;
    setPos({ x: Math.max(0, Math.min(window.innerWidth-380, e.clientX - dragOffset.current.x)), y: Math.max(0, Math.min(window.innerHeight-80, e.clientY - dragOffset.current.y)) });
  }, [dragging]);
  ...
  const onTouchMove = e => {
    const t = e.touches[0];
    setPos({ x: Math.max(0, Math.min(window.innerWidth-340, t.clientX - dragOffset.current.x)), y: Math.max(0, Math.min(window.innerHeight-80, t.clientY - dragOffset.current.y)) });
  };
  ...
  return (
    <div ref={winRef} style={{
      position:"fixed", left:pos.x, top:pos.y, width:360, maxHeight:"82vh",
      background:"rgba(10,14,25,0.97)", border:`1px solid ${s.border}`,
      borderRadius:12, boxShadow:`0 0 0 1px rgba(99,102,241,0.15), 0 8px 40px rgba(0,0,0,0.7), 0 0 20px ${s.border}22`,
      zIndex:200, display:"flex", flexDirection:"column",
      backdropFilter:"blur(12px)", userSelect:dragging?"none":"auto",
      transition: dragging ? "none" : "box-shadow 0.2s",
    }}>
      {/* Title bar — drag handle */}
      <div onMouseDown={onMouseDown} onTouchStart={onTouchStart} onTouchMove={onTouchMove}
        style={{padding:"10px 14px 8px", borderBottom:`1px solid #1e2432`, cursor:dragging?"grabbing":"grab",
          display:"flex", alignItems:"center", gap:8, flexShrink:0, borderRadius:"12px 12px 0 0",
          background:"linear-gradient(135deg,rgba(30,32,64,0.8),rgba(15,18,32,0.8))"}}>
        <span style={{fontSize:11,color:"#818cf8",fontFamily:"'Space Grotesk',sans-serif",fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",flex:1}}>{item.label}</span>
        <span style={{fontSize:9,color:"#374151",flexShrink:0}}>⠿ drag</span>
        <button className="no-drag" onClick={onClose} style={{background:"rgba(239,68,68,0.15)",border:"1px solid #ef4444",color:"#fca5a5",width:22,height:22,borderRadius:5,cursor:"pointer",fontSize:13,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontWeight:"bold"}} title="Close">✕</button>
      </div>

      {/* Status + action bar */}
      <div className="no-drag" style={{padding:"8px 14px",borderBottom:"1px solid #1e2432",flexShrink:0}}>
        <div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:6}}>
          <span className="badge" style={{background:s.badge,color:s.text}}>{item.status}</span>
          {openF>0&&<span className="badge" style={{background:"#7f1d1d",color:"#fca5a5"}}>⚠ {openF}</span>}
          {item.isLoaned&&<span className="badge" style={{background:"#4a1d96",color:"#c084fc"}}>📤 {item.loanedTo}</span>}
          {item.assetCode&&<span className="badge" style={{background:"#1e2432",color:"#4b5563"}}>#{item.assetCode}</span>}
        </div>
        <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
          <button className="btn no-drag" style={{fontSize:9,padding:"3px 8px",background:"#4c1d95",borderColor:"#7c3aed",color:"#c4b5fd"}} onClick={onReportFault}>⚠ Fault</button>
          <button className="btn no-drag" style={{fontSize:9,padding:"3px 8px"}} onClick={onMove}>⇄ Move</button>
          {item.loanable&&!item.isLoaned&&<button className="btn no-drag" style={{fontSize:9,padding:"3px 8px",background:"#064e3b",borderColor:"#059669",color:"#6ee7b7"}} onClick={onLoanOut}>📤 Loan</button>}
          {item.isLoaned&&<button className="btn no-drag" style={{fontSize:9,padding:"3px 8px",background:"#1e3a5f",borderColor:"#3b82f6",color:"#93c5fd"}} onClick={onReturn}>↩ Return</button>}
        </div>
      </div>

      {/* Tabs */}
      <div className="no-drag" style={{display:"flex",gap:2,padding:"6px 14px 0",borderBottom:"1px solid #1e2432",flexShrink:0}}>
        {[["details","Details"],["faults",`Faults${openF>0?" ("+openF+")":""}`],["repairs","Repairs"],["history","History"]].map(([k,l])=>(
          <button key={k} className="tab-btn no-drag" onClick={()=>setDetailTab(k)} style={{padding:"3px 9px",fontSize:10,borderRadius:"4px 4px 0 0",background:detailTab===k?"#1a1d2e":"none",color:detailTab===k?"#a5b4fc":"#4b5563",border:detailTab===k?"1px solid #2d3748":"1px solid transparent",borderBottom:"none"}}>{l}</button>
        ))}
      </div>

      {/* Content */}
      <div className="no-drag" style={{flex:1,overflowY:"auto",padding:"12px 14px"}}>
        {detailTab==="details"&&(
          editing?(
            <div style={{display:"flex",flexDirection:"column",gap:7}}>
              {[["label","Label"],["assetCode","Asset Code"],["brand","Brand"],["model","Model"],["serial","Serial No."],["cost","Cost ($)"]].map(([k,l])=>(
                <div key={k}><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:2}}>{l}</label><input value={ed[k]||""} onChange={e=>setEd(d=>({...d,[k]:e.target.value}))} /></div>
              ))}
              <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:2}}>Location</label>
                <select value={ed.location||""} onChange={e=>setEd(d=>({...d,location:e.target.value}))}>{allLocations.map(l=><option key={l}>{l}</option>)}</select>
              </div>
              ...
              <label style={{fontSize:10,color:"#4b5563",display:"flex",alignItems:"center",gap:6,cursor:"pointer"}}>
                <input type="checkbox" checked={!!ed.loanable} onChange={e=>setEd(d=>({...d,loanable:e.target.checked}))} style={{width:"auto"}} /> Loanable
              </label>
            ...
            <div>
              <div style={{fontSize:11,color:"#6b7280",marginBottom:6}}>{itype(item.type)} {item.type} · {item.brand} {item.model}</div>
              <div style={{display:"grid",gap:3,marginBottom:10}}>
                {[["Asset Code",item.assetCode||"—"],["Location",item.location],["Serial",item.serial||"—"],["Cost",item.cost?`$${Number(item.cost).toLocaleString()}`:"—"],
              ...
              <div style={{display:"flex",gap:6,marginTop:10}}>
                <button className="btn" onClick={()=>{setEd({...item});setEditing(true)}} style={{flex:1,fontSize:11}}>✏ Edit</button>
            ...
            {(item.faults||[]).map(f=>{
              ...
              return <div key={f.id} style={{background:"#080b12",border:"1px solid #1e2432",borderRadius:5,padding:9}}>
                ...
                <select value={f.status} onChange={e=>{
                  if(e.target.value==="Resolved"){const by=prompt("Resolved by:");const note=prompt("Resolution note:");onUpdateFault(f.id,{status:"Resolved",resolvedBy:by||"",resolutionNote:note||""});}
            ...
            {showRepair&&(
              <div style={{background:"#080b12",border:"1px solid #1e2432",borderRadius:5,padding:9,marginBottom:9,display:"flex",flexDirection:"column",gap:6}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                  ...
                  <div><label style={{fontSize:9,color:"#4b5563"}}>Complete</label><input type="date" value={repairForm.completeDate} onChange={e=>setRepairForm(f=>({...f,completeDate:e.target.value}))} /></div>
                </div>
                ...
                <button className="btn btn-primary" onClick={()=>{if(!repairForm.description)return;onAddRepair(repairForm);setRepairForm({description:"",technician:"",costRepair:"",startDate:"",completeDate:"",notes:""});setShowRepair(false);}} style={{fontSize:11}}>Save</button>
              </div>
            )}
        ...
        {detailTab==="history"&&(
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            ...
            {(item.moveLog||[]).length===0&&<div style={{color:"#2d3748",fontSize:11,textAlign:"center",padding:12}}>No movements</div>}
            {(item.moveLog||[]).map(m=>(
            ...
            <div style={{fontSize:10,color:"#818cf8",marginTop:6,marginBottom:4}}>Loan History</div>
            {(item.loanHistory||[]).length===0&&<div style={{color:"#2d3748",fontSize:11,textAlign:"center",padding:12}}>No loan records</div>}
            {(item.loanHistory||[]).map(l=>(
              <div key={l.id} style={{background:"#080b12",border:`1px solid ${l.status==="Active"?"#6366f1":"#1e2432"}`,borderRadius:5,padding:8}}>
                ...
                {l.expectedReturn&&<div style={{fontSize:10,color:"#4b5563"}}>Expected: {fmtDate(l.expectedReturn)}</div>}
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:6,marginTop:4}}>
      <div>
        ...
        <div style={{fontSize:11,color:"#9ca3af",background:"#080b12",border:"1px solid #1e2432",borderRadius:4,padding:"5px 8px",minHeight:26}}>{remark||<span style={{color:"#2d3748"}}>—</span>}</div>
      </div>
      <div>
        <div style={{fontSize:9,color:"#4b5563",marginBottom:2}}>COMMENT (admin note)</div>
        <div style={{fontSize:11,color:"#9ca3af",background:"#080b12",border:"1px solid #1e2432",borderRadius:4,padding:"5px 8px",minHeight:26}}>{comment||<span style={{color:"#2d3748"}}>—</span>}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:6}}>
      ...
      <div>
        ...
        <textarea rows={2} maxLength={300} value={comment} onChange={e=>onChange("comment",clamp(e.target.value,300))} placeholder="Admin observations..." />
      </div>
    </div>
  );
}
...
export default function App() {
  const [items, setItems] = useState(()=>{ try{const s=localStorage.getItem("invmap_v1"); return s?JSON.parse(s):RAW_ITEMS;}catch{return RAW_ITEMS;} });
  const [sections, setSections] = useState(()=>{ try{const s=localStorage.getItem("invmap_sec_v1"); return s?JSON.parse(s):INITIAL_SECTIONS;}catch{return INITIAL_SECTIONS;} });
  const [moveLog, setMoveLog] = useState(()=>{ try{const s=localStorage.getItem("invmap_log_v1"); return s?JSON.parse(s):[];}catch{return [];} });
  const [selectedItems, setSelectedItems] = useState(new Set()); // multi-select IDs
  ...
  useEffect(()=>{ try{localStorage.setItem("invmap_v1",JSON.stringify(items));}catch{} },[items]);
  useEffect(()=>{ try{localStorage.setItem("invmap_sec_v1",JSON.stringify(sections));}catch{} },[sections]);
  useEffect(()=>{ try{localStorage.setItem("invmap_log_v1",JSON.stringify(moveLog));}catch{} },[moveLog]);

  const updateItem = (id, patch) => {
    setItems(prev => prev.map(i => {
      if(i.id !== id) return i;
      const updated = {...i,...patch};
      if(patch.status === "Waiting for Condemnation" && i.location !== CONDEMNED_SECTION) { updated.location = CONDEMNED_SECTION; updated._prevLocation = i.location; }
      if(patch.status && patch.status !== "Waiting for Condemnation" && i.status === "Waiting for Condemnation") { updated.location = i._prevLocation || "Spare"; }
      return updated;
    }));
  ...
  const moveItemFn = (itemId, toLocation, reason, movedBy) => {
  ...
  const deleteRoom = (section, room, redirectTo) => {
    setSections(p=>({...p,[section]:(p[section]||[]).filter(r=>r!==room)}));
    const dest = redirectTo || "Spare";
    setItems(p=>p.map(i=>i.location===room?{...i,location:dest}:i));
  };
  const moveRoomToSection = (fromSection, toSection, room) => {
    if(fromSection===toSection||!sections[toSection]) return;
    setSections(p=>({
      ...p,
      [fromSection]:(p[fromSection]||[]).filter(r=>r!==room),
      [toSection]:[...(p[toSection]||[]),room],
    }));
  };
  const reorderRooms = (section, fromIdx, toIdx) => {
    setSections(p=>{ const rooms=[...(p[section]||[])]; const [moved]=rooms.splice(fromIdx,1); rooms.splice(toIdx,0,moved); return {...p,[section]:rooms}; });
  };

  const toggleSelectItem = (itemId, shiftHeld) => {
    if(!shiftHeld) { setSelectedItems(new Set([itemId])); return; }
  ...
  const bulkMoveItems = (toLocation, reason, movedBy) => {
    selectedItems.forEach(id => moveItemFn(id, toLocation, reason, movedBy));
    clearSelection();
  };
  ...
  const onRoomCardDrop = (e,room,section) => {
    e.preventDefault();
    if(dragRoom && dragRoom!==room) { const rooms=sections[section]||[]; const fi=rooms.indexOf(dragRoom); const ti=rooms.indexOf(room); if(fi>=0&&ti>=0) reorderRooms(section,fi,ti); }
    setDragRoom(null); setDragOverRoom(null);
  };

  const stats = {
    total:items.length, operational:items.filter(i=>i.status==="Operational").length,
    faulty:items.filter(i=>i.status==="Faulty").length, maintenance:items.filter(i=>i.status==="Under Maintenance").length,
    condemned:items.filter(i=>i.status==="Waiting for Condemnation").length, loaned:items.filter(i=>i.isLoaned).length,
    openFaults:items.reduce((n,i)=>n+(i.faults||[]).filter(f=>f.status!=="Resolved").length,0),
    warrantyExpired:items.filter(i=>isExpired(i.warrantyEnd)).length, expiringSoon:items.filter(i=>expiringSoon(i.warrantyEnd)).length,
  };
  ...
  const exportCSV = () => {
    ...
    const a=document.createElement("a"); a.href=URL.createObjectURL(new Blob([csv],{type:"text/csv"})); a.download=`InventoryMap_${new Date().toISOString().slice(0,10)}.csv`; a.click();
  };

  const fullSelected = selectedItem ? items.find(i=>i.id===selectedItem.id)||selectedItem : null;
  const allLocations = Object.values(sections).flat();

  const openItem = item => { setSelectedItem(item); setDetailTab("details"); };
    ...
    <div style={{fontFamily:"'DM Mono','Courier New',monospace",background:"#080b12",minHeight:"100vh",color:"#e2e8f0",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{padding:"10px 16px",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(78px,1fr))",gap:6,flexShrink:0}}>
        {[
          ...
          <div key={s.label} onClick={s.click} style={{background:"#0d1117",border:"1px solid #1e2432",borderRadius:6,padding:"7px 8px",textAlign:"center",cursor:s.click?"pointer":"default",transition:"border .15s"}}
            onMouseEnter={e=>{if(s.click)e.currentTarget.style.borderColor="#6366f1"}} onMouseLeave={e=>e.currentTarget.style.borderColor="#1e2432"}>
      ...
      <div style={{flex:1,overflow:"auto",padding:"14px 16px"}}>
        {tab==="sections"&&(
          <SectionsView items={items} sections={sections} activeSection={activeSection} setActiveSection={setActiveSection}
            onSelectItem={openItem} onAddItem={loc=>setModal({type:"additem",location:loc})}
            ...
            onRoomCardDragStart={onRoomCardDragStart} onRoomCardDrop={onRoomCardDrop}
            onMoveItem={item=>setModal({type:"move",item,pendingLocation:null})}
            dragItem={dragItem} dragRoom={dragRoom}
            selectedItems={selectedItems} onToggleSelect={toggleSelectItem}
          />
        )}
        {tab==="list"&&<ListView items={items} search={search} setSearch={setSearch} filterType={filterType} setFilterType={setFilterType} filterStatus={filterStatus} setFilterStatus={setFilterStatus} onSelectItem={openItem} />}
        {tab==="faults"&&<FaultsView items={items} onSelectItem={openItem} onUpdateFault={updateFault} setLightbox={setLightbox} />}
        {tab==="loans"&&<LoansView items={items} onSelectItem={openItem} onReturn={item=>setModal({type:"return",item})} onLoanOut={item=>setModal({type:"loanout",item})} />}
      </div>
      ...
      {fullSelected && (
        <div className="float-entry">
          <FloatingWindow
            item={fullSelected} detailTab={detailTab} setDetailTab={setDetailTab}
      ...
      {/* ── MODALS */}
      {modal?.type==="move"&&<MoveModal item={modal.item} pendingLocation={modal.pendingLocation} allLocations={allLocations} onMove={(loc,reason,by)=>{moveItemFn(modal.item.id,loc,reason,by);setModal(null)}} onClose={()=>setModal(null)} />}
      {modal?.type==="bulkmove"&&<BulkMoveModal count={selectedItems.size} allLocations={allLocations} onMove={(loc,reason,by)=>{bulkMoveItems(loc,reason,by);setModal(null)}} onClose={()=>setModal(null)} />}
      ...
      {modal?.type==="return"&&<ReturnModal item={modal.item} allLocations={allLocations} onSubmit={d=>{returnItem(modal.item.id,d);setModal(null)}} onClose={()=>setModal(null)} />}
      ...
      {modal?.type==="settings"&&<SettingsModal sections={sections} onAddSection={addSection} onRenameSection={renameSection} onDeleteSection={deleteSection} onAddRoom={addRoom} onRenameRoom={renameRoom} onDeleteRoom={deleteRoom} onMoveRoom={moveRoomToSection} onClose={()=>setModal(null)} />}
      {lightbox&&<div className="lightbox" onClick={()=>setLightbox(null)}><img src={lightbox} alt=""/></div>}

      {/* ── MULTI-SELECT ACTION BAR */}
      {selectedItems.size>0&&(
        <div style={{position:"fixed",bottom:20,left:"50%",transform:"translateX(-50%)",background:"#1a1d2e",border:"1px solid #6366f1",borderRadius:10,padding:"10px 16px",display:"flex",alignItems:"center",gap:12,zIndex:190,boxShadow:"0 4px 24px rgba(0,0,0,0.6)"}}>
          <span style={{fontSize:12,color:"#a5b4fc",fontFamily:"'Space Grotesk',sans-serif"}}>{selectedItems.size} item{selectedItems.size>1?"s":""} selected</span>
          <button className="btn btn-primary" style={{fontSize:11}} onClick={()=>setModal({type:"bulkmove"})}>⇄ Move All</button>
          <button className="btn" style={{fontSize:11}} onClick={clearSelection}>✕ Clear</button>
          <span style={{fontSize:10,color:"#374151"}}>Shift+click to add more</span>
        </div>
      )}
    </div>
  );
...
// ─── SECTIONS VIEW ────────────────────────────────────────────────────────────
function SectionsView({items,sections,activeSection,setActiveSection,onSelectItem,onAddItem,onDragItemStart,onDragItemEnd,onRoomDragOver,onRoomDrop,dragOverRoom,onRoomCardDragStart,onRoomCardDrop,onMoveItem,dragItem,dragRoom,selectedItems,onToggleSelect}) {
  ...
  return (
    <div>
      ...
      <div style={{fontSize:10,color:"#374151",marginBottom:10}}>Shift+click items to multi-select · drag chips or room headers to reorder</div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(190px,1fr))",gap:10}}>
        {rooms.map(room=>{
          const roomItems=items.filter(i=>i.location===room);
          const hasIssue=roomItems.some(i=>i.status==="Faulty");
          const hasMaint=roomItems.some(i=>["Under Maintenance"].includes(i.status));
          const isCondemned=roomItems.some(i=>i.status==="Waiting for Condemnation");
          ...
          return (
            <div key={room} className={`room-card${isDropTarget?" drop-target":""}`}
              style={{background:isDropTarget?"#1a1d2e":"#0d1117",border:`1px solid ${hasIssue?"#dc2626":hasMaint?"#f59e0b":isCondemned?"#f97316":"#1e2432"}`,padding:10}}
              draggable onDragStart={e=>onRoomCardDragStart(e,room)}
              onDragOver={e=>{onRoomDragOver(e,room);e.preventDefault()}}
              onDrop={e=>{if(dragItem)onRoomDrop(e,room);else if(dragRoom&&dragRoom!==room){const fi=rooms.indexOf(dragRoom);const ti=rooms.indexOf(room);if(fi>=0&&ti>=0)onRoomCardDrop(e,room,activeSection);}}}
            >
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
                <div style={{fontSize:11,fontWeight:500,color:"#818cf8",fontFamily:"'Space Grotesk',sans-serif",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:"75%"}} title={room}>⠿ {room}</div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:3,minHeight:24}}>
                ...
                {roomItems.map(item=>(
                  <ItemChip key={item.id} item={item}
                    onSelect={(e)=>{ if(e?.shiftKey) onToggleSelect(item.id,true); else onSelectItem(item); }}
                    onDragStart={onDragItemStart} onDragEnd={onDragItemEnd}
...
function ItemChip({item,onSelect,onDragStart,onDragEnd,onMove,isSelected,onToggleSelect}) {
  const s=sc(item.status);
  const openF=(item.faults||[]).filter(f=>f.status!=="Resolved").length;
  return (
    <div className="chip" draggable onDragStart={e=>onDragStart(e,item)} onDragEnd={onDragEnd}
      style={{background:isSelected?"#1e2240":"#080b12",border:`1px solid ${isSelected?"#6366f1":s.border}`,padding:"3px 6px",display:"flex",alignItems:"center",gap:4,outline:isSelected?"2px solid #6366f1":undefined,outlineOffset:-1}}>
      <span style={{fontSize:10,flexShrink:0}}>{itype(item.type)}</span>
      <div style={{flex:1,minWidth:0,cursor:"pointer"}} onClick={e=>onSelect(e)}>
        <div style={{fontSize:10,color:isSelected?"#a5b4fc":"#e2e8f0",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{item.label}</div>
        <div style={{fontSize:9,color:"#374151"}}>{item.brand} {item.model}</div>
      </div>
      ...
      {isExpired(item.warrantyEnd)&&<span style={{fontSize:9,color:"#ef4444",flexShrink:0}}>W!</span>}
      <button onClick={e=>{e.stopPropagation();onToggleSelect(item.id,true);}} title="Shift+click or tap ✓ to multi-select" style={{background:"none",border:"none",cursor:"pointer",color:isSelected?"#6366f1":"#1e2432",fontSize:10,padding:"0 1px",flexShrink:0}}>✓</button>
      <button onClick={e=>{e.stopPropagation();onMove()}} style={{background:"none",border:"none",cursor:"pointer",color:"#374151",fontSize:10,padding:"0 1px",flexShrink:0}}>⇄</button>
    </div>
  );
}
  ...
  return (
    <div>
      <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"}}>
        <input placeholder="🔍 Search label, serial, brand, model, location..." value={search} onChange={e=>setSearch(e.target.value)} style={{flex:1,minWidth:180}} />
      ...
      <div style={{fontSize:10,color:"#374151",marginBottom:6}}>{filtered.length} items — click any row to open floating detail window</div>
      <div style={{overflowX:"auto"}}>
        <table style={{width:"100%",borderCollapse:"collapse",fontSize:11}}>
          <thead><tr style={{borderBottom:"1px solid #1e2432"}}>{["Label","Type","Brand","Model","Serial","Location","Cost","Warranty","Status","Loan"].map(h=><th key={h} style={{padding:"5px 7px",textAlign:"left",color:"#374151",fontWeight:400,whiteSpace:"nowrap"}}>{h}</th>)}</tr></thead>
          <tbody>{filtered.map(item=>{
            const s2=sc(item.status); const openF=(item.faults||[]).filter(f=>f.status!=="Resolved").length;
            return <tr key={item.id} onClick={()=>onSelectItem(item)} style={{borderBottom:"1px solid #0d1117",cursor:"pointer",transition:"background .1s"}} onMouseEnter={e=>e.currentTarget.style.background="#0d1117"} onMouseLeave={e=>e.currentTarget.style.background=""}>
              <td style={{padding:"4px 7px",color:"#818cf8"}}>{item.label}{openF>0&&<span style={{color:"#fca5a5",marginLeft:4,fontSize:9}}>⚠{openF}</span>}</td>
              <td style={{padding:"4px 7px",color:"#374151",whiteSpace:"nowrap"}}>{itype(item.type)} {item.type}</td>
              ...
              <td style={{padding:"4px 7px",color:isExpired(item.warrantyEnd)?"#ef4444":expiringSoon(item.warrantyEnd)?"#facc15":"#374151",whiteSpace:"nowrap"}}>{fmtDate(item.warrantyEnd)}</td>
              <td style={{padding:"4px 7px"}}><span className="badge" style={{background:s2.badge,color:s2.text}}>{item.status}</span></td>
              <td style={{padding:"4px 7px"}}>{item.isLoaned&&<span style={{color:"#c084fc",fontSize:10,whiteSpace:"nowrap"}}>📤 {item.loanedTo}</span>}</td>
            </tr>;
          })}</tbody>
        </table>
      </div>
...
function FaultsView({items,onSelectItem,onUpdateFault,setLightbox}) {
  ...
  return (
    <div>
      ...
      {filtered.length===0&&<div style={{textAlign:"center",color:"#1e2432",padding:40,fontSize:13}}>No faults matching filter</div>}
            ...
            <div style={{display:"flex",gap:8,alignItems:"flex-start",flexWrap:"wrap"}}>
              <div style={{flex:1,minWidth:0}}>
                <div style={{display:"flex",gap:6,alignItems:"center",marginBottom:4,flexWrap:"wrap"}}>
                  ...
                  <span style={{fontSize:10,color:"#1e2432",marginLeft:"auto"}}>{fmtDate(f.date)}</span>
                </div>
                ...
                {f.reportedBy&&<div style={{fontSize:10,color:"#374151"}}>By: {f.reportedBy}</div>}
                {f.resolvedBy&&<div style={{fontSize:10,color:"#4ade80",marginTop:2}}>Resolved by {f.resolvedBy}</div>}
  ...
  return (
    <div>
      <div style={{display:"flex",gap:8,marginBottom:12,alignItems:"center",flexWrap:"wrap"}}>
        <div style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:13,color:"#818cf8"}}>{loaned.length} items on loan · {sorted.length} people</div>
        <button className="btn" onClick={()=>setShowAll(!showAll)} style={{marginLeft:"auto"}}>{showAll?"Hide":"Show"} available ({loanable.length})</button>
      </div>
      {showAll&&(
          ...
          return (
            <div key={person} style={{background:"#0d1117",border:`1px solid ${isJeff?"#6366f1":"#1e2432"}`,borderRadius:8,padding:10}}>
              <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:8}}>
                <div style={{width:28,height:28,borderRadius:"50%",background:isJeff?"#1e2240":"#1a1d2e",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"#818cf8",fontWeight:500,flexShrink:0}}>{person.slice(0,2).toUpperCase()}</div>
                <div style={{flex:1,minWidth:0}}>
  ...
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{fontSize:11,color:"#374151",marginBottom:12}}>From: <span style={{color:"#9ca3af"}}>{item.location}</span></div>
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>New Location *</label><select value={loc} onChange={e=>setLoc(e.target.value)}>{allLocations.map(l=><option key={l}>{l}</option>)}</select></div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Reason *</label><textarea rows={2} placeholder="e.g. Fault, event relocation..." value={reason} onChange={e=>setReason(e.target.value)} /></div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Moved By</label><input placeholder="Your name" value={by} onChange={e=>setBy(e.target.value)} /></div>
  ...
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Fault Type</label><select value={form.faultType} onChange={e=>setForm(f=>({...f,faultType:e.target.value}))}>{FAULT_TYPES.map(t=><option key={t}>{t}</option>)}</select></div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Severity</label>
            <div style={{display:"flex",gap:5}}>{["Low","Medium","High","Critical"].map(s=>{const sc2=SEV_COLORS[s];return <button key={s} onClick={()=>setForm(f=>({...f,severity:s}))} style={{flex:1,padding:"5px 3px",border:`1px solid ${form.severity===s?sc2.text:"#2d3748"}`,borderRadius:4,cursor:"pointer",background:form.severity===s?sc2.bg:"#080b12",color:form.severity===s?sc2.text:"#4b5563",fontSize:10,fontFamily:"inherit"}}>{s}</button>;})}
            </div>
          </div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Description</label><textarea rows={3} placeholder="Describe the fault..." value={form.description} onChange={e=>setForm(f=>({...f,description:e.target.value}))} /></div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Reported By</label><input placeholder="Your name" value={form.reportedBy} onChange={e=>setForm(f=>({...f,reportedBy:e.target.value}))} /></div>
          <div>
          ...
          <div style={{display:"flex",gap:8}}><button className="btn btn-primary" style={{flex:1}} onClick={()=>onSubmit(form)}>Submit</button><button className="btn" onClick={onClose}>Cancel</button></div>
        </div>
      </div>
    </div>
  );
...
function LoanOutModal({item,onSubmit,onClose}) {
  ...
  const submit=()=>{ if(!form.borrowerName) return alert("Borrower name required."); onSubmit({...form,signature:hasSig?sigRef.current.toDataURL():null}); };
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          ...
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Expected Return</label><input type="date" value={form.expectedReturn} onChange={e=>setForm(f=>({...f,expectedReturn:e.target.value}))} /></div>
          ...
          <div>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}><label style={{fontSize:10,color:"#4b5563"}}>Borrower Signature</label><button onClick={clearSig} style={{background:"none",border:"none",cursor:"pointer",color:"#4b5563",fontSize:10}}>Clear</button></div>
          ...
          <div style={{display:"flex",gap:8}}><button className="btn btn-primary" style={{flex:1}} onClick={submit}>Confirm Loan Out</button><button className="btn" onClick={onClose}>Cancel</button></div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{fontSize:11,color:"#374151",marginBottom:12}}>With: <span style={{color:"#9ca3af"}}>{item.loanedTo}</span></div>
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Return to Location</label><select value={form.returnLocation} onChange={e=>setForm(f=>({...f,returnLocation:e.target.value}))}>{allLocations.map(l=><option key={l}>{l}</option>)}</select></div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Condition</label><select value={form.condition} onChange={e=>setForm(f=>({...f,condition:e.target.value}))}>{["Good","Fair","Damaged","Missing Parts"].map(c=><option key={c}>{c}</option>)}</select></div>
          ...
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Notes</label><textarea rows={2} value={form.notes} onChange={e=>setForm(f=>({...f,notes:e.target.value}))} /></div>
          <div style={{display:"flex",gap:8}}><button className="btn btn-primary" style={{flex:1}} onClick={()=>onSubmit(form)}>Confirm Return</button><button className="btn" onClick={onClose}>Cancel</button></div>
        </div>
      </div>
    </div>
  );
...
function ReportModal({items,onClose}) {
  ...
  items.forEach(i=>{ byType[i.type]=(byType[i.type]||0)+1; byBrand[i.brand||"Unknown"]=(byBrand[i.brand||"Unknown"]||0)+1; byStatus[i.status]=(byStatus[i.status]||0)+1; });
  const expired=items.filter(i=>isExpired(i.warrantyEnd));
  const printReport=()=>{
    const w=window.open("","_blank");
    w.document.write(`<html><head><title>${APP_TITLE} — Report</title><style>body{font-family:monospace;padding:20px;color:#000}table{border-collapse:collapse;width:100%}td,th{border:1px solid #ccc;padding:6px 10px;font-size:12px}th{background:#f0f0f0}h2{margin-top:20px}@media print{button{display:none}}</style></head><body>`);
    w.document.write(`<h1>${APP_TITLE} — Inventory Report</h1><p>Generated: ${new Date().toLocaleString("en-SG")}</p><p>Total items: ${items.length}</p>`);
    ...
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal" style={{width:"min(600px,100%)"}}>
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:14,alignItems:"center"}}>
          <div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:600,color:"#818cf8"}}>{APP_TITLE} — Inventory Report</div>
          <div style={{display:"flex",gap:6}}><button className="btn" onClick={printReport}>🖨 Print</button><button onClick={onClose} style={{background:"none",border:"none",cursor:"pointer",color:"#4b5563",fontSize:20}}>×</button></div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(90px,1fr))",gap:8,marginBottom:14}}>
          {[["Total",items.length,"#818cf8"],["Operational",items.filter(i=>i.status==="Operational").length,"#4ade80"],["On Loan",items.filter(i=>i.isLoaned).length,"#c084fc"],["Expired Warranty",expired.length,"#ef4444"],["Open Faults",items.reduce((n,i)=>n+(i.faults||[]).filter(f=>f.status!=="Resolved").length,0),"#f97316"],["Condemned",items.filter(i=>i.status==="Waiting for Condemnation").length,"#fb923c"]].map(([l,v,c])=>(
            <div key={l} style={{background:"#080b12",border:"1px solid #1e2432",borderRadius:6,padding:"8px 10px",textAlign:"center"}}>
              <div style={{fontSize:18,fontWeight:500,color:c,fontFamily:"'Space Grotesk',sans-serif"}}>{v}</div>
              <div style={{fontSize:9,color:"#374151",marginTop:2}}>{l}</div>
            </div>
          ))}
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
          <div><div style={{fontSize:11,color:"#818cf8",marginBottom:6}}>By Type</div>{Object.entries(byType).sort((a,b)=>b[1]-a[1]).map(([k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"3px 0",borderBottom:"1px solid #0d1117",fontSize:11}}><span style={{color:"#9ca3af"}}>{itype(k)} {k}</span><span style={{color:"#e2e8f0"}}>{v}</span></div>)}</div>
          <div><div style={{fontSize:11,color:"#818cf8",marginBottom:6}}>By Brand</div>{Object.entries(byBrand).sort((a,b)=>b[1]-a[1]).map(([k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"3px 0",borderBottom:"1px solid #0d1117",fontSize:11}}><span style={{color:"#9ca3af"}}>{k}</span><span style={{color:"#e2e8f0"}}>{v}</span></div>)}</div>
        </div>
        {expired.length>0&&<div style={{marginTop:14}}><div style={{fontSize:11,color:"#ef4444",marginBottom:6}}>Warranty Expired ({expired.length})</div><div style={{maxHeight:140,overflow:"auto"}}>{expired.map(i=><div key={i.id} style={{display:"flex",gap:8,fontSize:10,padding:"2px 0",borderBottom:"1px solid #0d1117"}}><span style={{color:"#818cf8",minWidth:80}}>{i.label}</span><span style={{color:"#9ca3af",flex:1}}>{i.brand} {i.model}</span><span style={{color:"#374151"}}>{i.location}</span><span style={{color:"#ef4444"}}>{fmtDate(i.warrantyEnd)}</span></div>)}</div></div>}
      </div>
    </div>
  );
}
...
function MoveLogModal({log,onClose}) {
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:12}}><div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:600,color:"#818cf8"}}>Movement Log</div><button onClick={onClose} style={{background:"none",border:"none",cursor:"pointer",color:"#4b5563",fontSize:20}}>×</button></div>
        {log.length===0&&<div style={{color:"#1e2432",textAlign:"center",padding:24,fontSize:12}}>No movements yet</div>}
        <div style={{display:"flex",flexDirection:"column",gap:6}}>{log.map(l=><div key={l.id} style={{background:"#080b12",border:"1px solid #1e2432",borderRadius:5,padding:9}}><div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}><span style={{fontSize:12,color:"#818cf8"}}>{l.itemLabel}</span><span style={{fontSize:10,color:"#1e2432"}}>{fmtDate(l.date)}</span></div><div style={{fontSize:11,color:"#9ca3af"}}>{l.from} → {l.to}</div><div style={{fontSize:11,color:"#4b5563",marginTop:2}}>Reason: {l.reason}</div>{l.movedBy&&<div style={{fontSize:10,color:"#374151"}}>By: {l.movedBy}</div>}</div>)}</div>
      </div>
    </div>
  );
}
    ...
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        <div style={{display:"flex",flexDirection:"column",gap:7}}>
          ...
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:2}}>Type</label><select value={form.type} onChange={e=>setForm(f=>({...f,type:e.target.value}))}>{Object.keys(TYPE_ICON).filter(k=>k!=="default").map(t=><option key={t}>{t}</option>)}</select></div>
          ...
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:2}}>Status</label>
            <select value={form.status} onChange={e=>setForm(f=>({...f,status:e.target.value}))}>{STATUS_LIST.map(s=><option key={s}>{s}</option>)}</select>
          ...
          <label style={{fontSize:10,color:"#4b5563",display:"flex",alignItems:"center",gap:7,cursor:"pointer"}}><input type="checkbox" checked={form.loanable} onChange={e=>setForm(f=>({...f,loanable:e.target.checked}))} style={{width:"auto"}} /> Loanable item</label>
          <RemarkCommentFields remark={form.remark} comment={form.comment} onChange={(k,v)=>setForm(f=>({...f,[k]:v}))} />
          <div style={{display:"flex",gap:8}}><button className="btn btn-primary" style={{flex:1}} onClick={()=>{if(!form.label.trim())return;onAdd(form);}}>Add Item</button><button className="btn" onClick={onClose}>Cancel</button></div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        ...
        {preview.length>0&&<div><div style={{fontSize:11,color:"#4ade80",marginBottom:6}}>{preview.length} items ready</div><div style={{maxHeight:150,overflow:"auto",marginBottom:10}}>{preview.slice(0,8).map((i,idx)=><div key={idx} style={{fontSize:10,color:"#9ca3af",padding:"2px 0"}}>{i.label} — {i.brand} {i.model} @ {i.location}</div>)}{preview.length>8&&<div style={{fontSize:10,color:"#374151"}}>...+{preview.length-8} more</div>}</div><button className="btn btn-primary" style={{width:"100%",marginBottom:6}} onClick={()=>onImport(preview)}>Import {preview.length} Items</button></div>}
...
function BulkMoveModal({count,allLocations,onMove,onClose}) {
  const [loc,setLoc]=useState("Spare");
  const [reason,setReason]=useState(""); const [by,setBy]=useState("");
  return (
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal">
        <div style={{fontFamily:"'Space Grotesk',sans-serif",fontWeight:600,color:"#818cf8",marginBottom:12}}>Move {count} Items</div>
        <div style={{fontSize:11,color:"#4b5563",marginBottom:12}}>All {count} selected items will be moved to the same destination.</div>
        <div style={{display:"flex",flexDirection:"column",gap:9}}>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Destination *</label>
            <select value={loc} onChange={e=>setLoc(e.target.value)}>{allLocations.map(l=><option key={l}>{l}</option>)}</select>
          </div>
          <div><label style={{fontSize:10,color:"#4b5563",display:"block",marginBottom:3}}>Reason *</label>
            <textarea rows={2} placeholder="e.g. Bulk relocation for event..." value={reason} onChange={e=>setReason(e.target.value)} />
          </div>
          ...
          <div style={{display:"flex",gap:8}}>
            <button className="btn btn-primary" style={{flex:1}} onClick={()=>{if(!reason.trim()){alert("Please enter a reason.");return;}onMove(loc,reason,by);}}>Confirm Move All</button>
            <button className="btn" onClick={onClose}>Cancel</button>
          </div>
        </div>
      </div>
...
function SettingsModal({sections,onAddSection,onRenameSection,onDeleteSection,onAddRoom,onRenameRoom,onDeleteRoom,onMoveRoom,onClose}) {
  const [selSec,setSelSec]=useState(Object.keys(sections)[0]||"");
  const [newSec,setNewSec]=useState(""); const [newRoom,setNewRoom]=useState(""); const [editSecName,setEditSecName]=useState("");
  const [movingRoom,setMovingRoom]=useState(null);
  const [moveRoomTarget,setMoveRoomTarget]=useState("");
  const otherSections = Object.keys(sections).filter(s=>s!==selSec);

  const handleDeleteRoom = (room) => {
    const redirect = window.prompt(`Items in "${room}" will be moved to which room?\n(Leave blank for "Spare")`, "Spare");
    if(redirect === null) return;
    onDeleteRoom(selSec, room, redirect.trim() || "Spare");
  };
      ...
      <div className="modal" style={{width:"min(580px,100%)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"180px 1fr",gap:12,minHeight:300}}>
          <div>
            ...
            {Object.keys(sections).map(s=>(
              <div key={s} onClick={()=>{setSelSec(s);setEditSecName("");setMovingRoom(null);}}
                style={{padding:"5px 8px",borderRadius:4,cursor:"pointer",fontSize:11,marginBottom:3,
                  background:selSec===s?"#1a1d2e":"transparent",
                  color:selSec===s?"#a5b4fc":"#9ca3af",
                  border:`1px solid ${selSec===s?"#374151":"transparent"}`}}>{s}</div>
            ))}
            <div style={{marginTop:8,display:"flex",gap:5}}>
              <input placeholder="New section..." value={newSec} onChange={e=>setNewSec(e.target.value)} style={{fontSize:10}}
                onKeyDown={e=>{if(e.key==="Enter"&&newSec.trim()){onAddSection(newSec.trim());setNewSec("");}}} />
              <button className="btn" onClick={()=>{if(newSec.trim()){onAddSection(newSec.trim());setNewSec("");}}} style={{padding:"4px 8px"}}>+</button>
            </div>
          </div>
          <div>
            {selSec&&<>
              <div style={{display:"flex",gap:6,marginBottom:10,alignItems:"center"}}>
                ...
                <button className="btn" onClick={()=>{
                  if(editSecName&&editSecName!==selSec){onRenameSection(selSec,editSecName);setSelSec(editSecName);setEditSecName("");}
                }} style={{padding:"4px 8px"}}>Rename</button>
                {selSec!==CONDEMNED_SECTION&&<button className="btn btn-danger" onClick={()=>{
                  if(confirm(`Delete section "${selSec}"? All rooms within will be removed.`)){onDeleteSection(selSec);setSelSec(Object.keys(sections)[0]);}
                }} style={{padding:"4px 8px"}}>Del</button>}
              </div>

              {movingRoom&&(
                <div style={{background:"#1a1d2e",border:"1px solid #6366f1",borderRadius:6,padding:10,marginBottom:10}}>
                  <div style={{fontSize:11,color:"#a5b4fc",marginBottom:6}}>Move "{movingRoom}" to:</div>
                  <div style={{display:"flex",gap:6}}>
                    <select value={moveRoomTarget} onChange={e=>setMoveRoomTarget(e.target.value)} style={{flex:1,fontSize:11}}>
                      <option value="">— pick section —</option>
                      {otherSections.map(s=><option key={s}>{s}</option>)}
                    </select>
                    <button className="btn btn-primary" style={{padding:"4px 8px",fontSize:11}} onClick={()=>{
                      if(moveRoomTarget){onMoveRoom(selSec,moveRoomTarget,movingRoom);setMovingRoom(null);setMoveRoomTarget("");}
                    }}>Move</button>
                    <button className="btn" style={{padding:"4px 8px",fontSize:11}} onClick={()=>setMovingRoom(null)}>Cancel</button>
                  </div>
                </div>
              )}

              <div style={{fontSize:10,color:"#4b5563",marginBottom:6}}>
                ROOMS <span style={{color:"#2d3748"}}>· rename inline · ↗ move to section · × delete</span>
              </div>
              <div style={{maxHeight:240,overflow:"auto",display:"flex",flexDirection:"column",gap:4,marginBottom:8}}>
                {(sections[selSec]||[]).length===0&&(
                  <div style={{fontSize:11,color:"#2d3748",padding:"10px 0",textAlign:"center"}}>No rooms yet — add one below</div>
                )}
                {(sections[selSec]||[]).map(room=>(
                  <div key={room} style={{display:"flex",gap:5,alignItems:"center"}}>
                    <input defaultValue={room} style={{fontSize:10,flex:1}}
                      onBlur={e=>{if(e.target.value.trim()&&e.target.value.trim()!==room)onRenameRoom(selSec,room,e.target.value.trim());}} />
                    <button title="Move to another section" onClick={()=>{setMovingRoom(room);setMoveRoomTarget(otherSections[0]||"");}}
                      style={{background:"none",border:"1px solid #374151",cursor:"pointer",color:"#818cf8",fontSize:11,padding:"2px 6px",borderRadius:3,flexShrink:0}}>↗</button>
                    <button className="btn btn-danger" onClick={()=>handleDeleteRoom(room)} style={{padding:"3px 7px",fontSize:10,flexShrink:0}}>×</button>
                  </div>
                ))}
              </div>
              <div style={{display:"flex",gap:5}}>
                <input placeholder="New room name..." value={newRoom} onChange={e=>setNewRoom(e.target.value)} style={{fontSize:10,flex:1}}
                  onKeyDown={e=>{if(e.key==="Enter"&&newRoom.trim()){onAddRoom(selSec,newRoom.trim());setNewRoom("");}}} />
                <button className="btn btn-primary" onClick={()=>{if(newRoom.trim()){onAddRoom(selSec,newRoom.trim());setNewRoom("");}}} style={{padding:"4px 8px"}}>Add</button>
              </div>
            </>}
          </div>
        </div>
  ...
  const [selSec,setSelSec]=useState(Object.keys(sections)[0]||"");
  const [newSec,setNewSec]=useState(""); const [newRoom,setNewRoom]=useState(""); const [editSecName,setEditSecName]=useState("");
  const [movingRoom,setMovingRoom]=useState(null); // room name being moved to another section
  const [moveRoomTarget,setMoveRoomTarget]=useState("");
  const allRooms = Object.values(sections).flat();
  const otherSections = Object.keys(sections).filter(s=>s!==selSec);

  const handleDeleteRoom = (room) => {
    const roomItems = []; // we can't access items here, so just warn
    const redirect = window.prompt(`Items in "${room}" will be moved to which room? (type room name, or leave blank for "Spare")`,  "Spare");
    ...
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal" style={{width:"min(580px,100%)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"180px 1fr",gap:12,minHeight:300}}>
          <div>
            <div style={{fontSize:10,color:"#4b5563",marginBottom:6}}>SECTIONS</div>
            {Object.keys(sections).map(s=><div key={s} onClick={()=>{setSelSec(s);setEditSecName("");}} style={{padding:"5px 8px",borderRadius:4,cursor:"pointer",fontSize:11,marginBottom:3,background:selSec===s?"#1a1d2e":"transparent",color:selSec===s?"#a5b4fc":"#9ca3af",border:`1px solid ${selSec===s?"#374151":"transparent"}`}}>{s}</div>)}
            <div style={{marginTop:8,display:"flex",gap:5}}>
              <input placeholder="New section..." value={newSec} onChange={e=>setNewSec(e.target.value)} style={{fontSize:10}} onKeyDown={e=>{if(e.key==="Enter"&&newSec){onAddSection(newSec);setNewSec("");}}} />
              <button className="btn" onClick={()=>{if(newSec){onAddSection(newSec);setNewSec("");}}} style={{padding:"4px 8px"}}>+</button>
            </div>
          </div>
          <div>{selSec&&<>
            <div style={{display:"flex",gap:6,marginBottom:10,alignItems:"center"}}>
              <input value={editSecName!==undefined&&editSecName!==""?editSecName:selSec} onChange={e=>setEditSecName(e.target.value)} style={{fontSize:11,flex:1}} />
              ...
              {selSec!==CONDEMNED_SECTION&&<button className="btn btn-danger" onClick={()=>{if(confirm(`Delete section "${selSec}"? All rooms will be removed.`)){onDeleteSection(selSec);setSelSec(Object.keys(sections)[0]);}}} style={{padding:"4px 8px"}}>Del</button>}
            </div>

            {/* Move room to another section */}
            {movingRoom&&(
              <div style={{background:"#1a1d2e",border:"1px solid #6366f1",borderRadius:6,padding:10,marginBottom:10}}>
                <div style={{fontSize:11,color:"#a5b4fc",marginBottom:6}}>Move "{movingRoom}" to section:</div>
                <div style={{display:"flex",gap:6}}>
                  <select value={moveRoomTarget} onChange={e=>setMoveRoomTarget(e.target.value)} style={{flex:1,fontSize:11}}>
                    <option value="">— pick section —</option>
                    {otherSections.map(s=><option key={s}>{s}</option>)}
                  </select>
                  <button className="btn btn-primary" style={{padding:"4px 8px",fontSize:11}} onClick={()=>{if(moveRoomTarget){onMoveRoom(selSec,moveRoomTarget,movingRoom);setMovingRoom(null);setMoveRoomTarget("");}}} >Move</button>
                  <button className="btn" style={{padding:"4px 8px",fontSize:11}} onClick={()=>setMovingRoom(null)}>Cancel</button>
                </div>
              </div>
            )}

            <div style={{fontSize:10,color:"#4b5563",marginBottom:6}}>ROOMS IN {selSec} <span style={{color:"#374151"}}>(click name to rename, ↗ to move to another section, × to delete)</span></div>
            <div style={{maxHeight:240,overflow:"auto",display:"flex",flexDirection:"column",gap:4,marginBottom:8}}>
              {(sections[selSec]||[]).length===0&&<div style={{fontSize:11,color:"#2d3748",padding:"10px 0",textAlign:"center"}}>No rooms yet</div>}
              {(sections[selSec]||[]).map(room=><div key={room} style={{display:"flex",gap:5,alignItems:"center"}}>
                <input defaultValue={room} key={room} style={{fontSize:10,flex:1}} onBlur={e=>{if(e.target.value&&e.target.value!==room)onRenameRoom(selSec,room,e.target.value);}} />
                <button title="Move to another section" onClick={()=>{setMovingRoom(room);setMoveRoomTarget(otherSections[0]||"");}} style={{background:"none",border:"1px solid #374151",cursor:"pointer",color:"#818cf8",fontSize:11,padding:"2px 5px",borderRadius:3}}>↗</button>
                <button className="btn btn-danger" onClick={()=>handleDeleteRoom(room)} style={{padding:"3px 6px",fontSize:10}}>×</button>
              </div>)}
            </div>
            <div style={{display:"flex",gap:5}}>
              ...
              <button className="btn btn-primary" onClick={()=>{if(newRoom){onAddRoom(selSec,newRoom);setNewRoom("");}}} style={{padding:"4px 8px"}}>Add</button>
            </div>
          </>}</div>
        </div>
      </div>
